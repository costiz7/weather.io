<img src="Assets/logo.png" alt="weather.io Homepage" width="300">

An interactive and responsive **weather website** that shows the current weather for any city using **two APIs**:  
...
- Smooth **animations** for weather updates and UI elements  
- Fully **responsive design** for desktop and mobile  
- Clean and modern **user interface**  

![weather.io homepage](https://imgur.com/JMGG7Xo.png)
